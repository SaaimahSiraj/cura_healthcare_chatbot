...
def get_diagnosis_chain():
    ...
    Ensure the response is clear, concise, and considers all listed symptoms.
    """
...
def conversational_chain():
    ...
    prompt = PromptTemplate(template=prom_template, input_variables=["context", "question"])
...
# Main function
def main():
    st.set_page_config(page_title="Cura(1)", page_icon="🩺")

    with st.sidebar:
        selected = option_menu(
            "Trail", ["Landing Page", "Consultation", "Medical Record Reader", "Nearest Doctors"],
    ...
    if selected == "Landing Page":
        ...
        with col2:
            ...
            <i>(Coming Soon)</i> Our tool will help you understand your medical history and share it with your healthcare providers.</p>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col4:
            lottie_hello = load_lottieurl("https://lottie.host/88319248-8994-431c-a635-aaf2ab675ecd/NQ2nhrJO4e.json")
            st_lottie(
                lottie_hello,
                speed=1,
                reverse=False,
        ...
        st.write("Upload and analyze your medical records. The AI will assist you in understanding the health data")
        ...
        if pdf_docs:
            ...
            user_question = st.text_input("Enter your query about the records")
